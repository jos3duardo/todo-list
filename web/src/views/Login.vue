...
<login-layout>
    ...
    <span slot="principal">
        ...
        <div class="row">
            <div class="col s6 m6">
                <button class="btn waves-light waves-effect z-depth-5" v-on:click="login()">Entrar</button>
            </div>
            <div class="col s6 m6">
                <router-link id="espaco" to="/cadastro"
                class="btn waves-light waves-effect orange z-depth-5">Cadastra-se</router-link>
            </div>
        </div>
    </span>
</login-layout>
